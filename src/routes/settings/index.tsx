              ...
              <CardContent className="space-y-6">
                ...
                <div className="grid gap-4 sm:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <Input id="name" defaultValue="Raheel Nadeem" className="bg-background/50" />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="email">Email Address</Label>
                    <Input id="email" defaultValue="raheel@example.com" className="bg-background/50" />
                  </div>
                  <div className="col-span-full space-y-2">
                    <Label htmlFor="bio">Professional Bio</Label>
                    <Input id="bio" placeholder="Software Engineer and Open Source Contributor" className="bg-background/50" />
                  </div>
                </div>
              </CardContent>
                      ...
                      <div className="flex items-center justify-between">
                         <div className="flex items-center gap-4">
                            ...
                            <div>
                               ...
                               <p className="text-xs text-muted-foreground">Connected to @raheelnadeem</p>
                            </div>
                         </div>
